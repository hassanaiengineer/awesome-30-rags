...
apply_streamlit_branding(
    ...
    page_icon="🧐",
    caption="Hassan Khan RAG Series • Retrieval + step-by-step reasoning + citations",
)
st.markdown("""
...
with col1:
    google_key = st.text_input(
        ...
        help="Used to call Gemini models.",
    )
with col2:
    openai_key = st.text_input(
        ...
        help="Used to generate embeddings for retrieval.",
    )
...
if google_key and openai_key:
    ...
    with st.sidebar:
        ...
        if st.session_state.knowledge_urls:
            ...
            st.info("No sources indexed yet. Add a URL to start.")
        ...
        new_url = st.text_input(
            ...
            help="Optional: URL to index into the knowledge base",
        )
