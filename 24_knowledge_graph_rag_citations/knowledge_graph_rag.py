...
def main():
    apply_streamlit_branding(
        st,
        title="Knowledge Graph RAG with Verifiable Citations",
        page_icon="🔍",
        caption="Hassan Khan RAG Series • Neo4j knowledge graph + local LLM via Ollama",
    )
    st.markdown("""
    ...
    neo4j_password = st.sidebar.text_input("Neo4j Password", type="password", value="")
