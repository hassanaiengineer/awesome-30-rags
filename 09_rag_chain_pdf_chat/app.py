...
def get_vector_store(gemini_api_key: str) -> Chroma:
...
def add_to_db(uploaded_files):
    ...
    db = get_vector_store(st.session_state.get("gemini_api_key", ""))
...
def main():
    ...
    apply_streamlit_branding(
        st,
        title="PharmaQuery (RAG Chain)",
        page_icon="🧪",
        caption="Hassan Khan RAG Series • PDF → Chroma → Gemini",
    )
    ...
    # Sidebar Footer
    st.sidebar.write("Built by Hassan Khan")
